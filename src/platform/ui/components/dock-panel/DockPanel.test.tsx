...
jest.mock("react-native", () => {
  ...
  // state instead of rendering it as a node — DockPanel's action/item
  // buttons (composing the platform Pressable) rely on that to read
  // `focused` for their focus ring, so this stub needs to match or React
  // warns about a function showing up as a literal child.
