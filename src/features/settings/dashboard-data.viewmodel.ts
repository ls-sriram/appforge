...
import { BackendUserProfileService, type UsageTrendGranularity } from "./user-profile.service";
import { BackendEntitlementService } from "../entitlements/entitlement.service";
import { api } from "../../platform/api/client";
import { useEntitlementContext } from "../../platform/providers/EntitlementProvider";
import { getEntitlementSnapshot, setEntitlementSnapshot } from "../entitlements/entitlements.store";
import { createMockEntitlementSnapshot } from "../entitlements/entitlements.model";
import { buildEntitlementSnapshot } from "../entitlements/entitlements.handler";
import { getLockedFeatures } from "../entitlements/entitlements.policy";
import type { FeatureKey } from "../entitlements/feature.keys";
import { asIsoUtcTimestamp, dateOwner } from "../../platform/core/dates/index";
