# AGENTS.md for `src/apps/example-app`

## Scope

- Applies to `src/apps/example-app/**`.

## Purpose

- Owns Example App-specific frontend code: feature slices, navigation, and app-owned presentation.
