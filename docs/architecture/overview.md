...
- `desktop/`: Electron entrypoints and preload bridge for the AppForge desktop bundle
...
- The AppForge desktop bundle targets `appforge-site`, asks for an AppForge repository on first launch, and writes visualizer saves into that selected repo root.
