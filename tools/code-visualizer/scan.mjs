...
function scanUiCompositionLayers() {
  return [
    ...
    },
    {
      ...
      rule: "Block + leaf atoms. No `style` prop. Every visual decision is a named token prop.",
      count: countFilesMatching("src/ui/primitives", [".tsx"]),
    },
    {
      id: "panels",
      label: "Panels",
      path: "src/ui/panels/**",
      rule: "Surface wrappers mapping semantic variants to Block paint. No feature imports.",
      count: countFilesMatching("src/ui/panels", [".tsx"]),
    },
    {
      id: "blocks",
      label: "Blocks",
      path: "src/ui/blocks/**",
      rule: "App-agnostic composites of primitives + panels. No feature, router, or domain imports.",
      count: countFilesMatching("src/ui/blocks", [".tsx"]),
    },
    {
      id: "app-shared-ui",
      label: "App-Shared UI",
